...
public class MyAnimalsLists {
    ...
    public static final List<Animal> mySecondList = Arrays.asList(
        new Animal("мяу", Animal.Type.CAT, Animal.Sex.F, 6, 32, 5000, true),
        new Animal("Dog", Animal.Type.DOG, Animal.Sex.F, 9, 57, 7000, true),
        ...
        new Animal("Douglas", Animal.Type.BIRD, Animal.Sex.F, 11, 34, 785, true),
        new Animal("Locker", Animal.Type.FISH, Animal.Sex.F, 3, 12, 245, true),
