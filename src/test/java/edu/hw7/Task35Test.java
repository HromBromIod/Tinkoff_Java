...
import edu.hw7.Task3.MyPersonDatabaseReadWriteLock;
...
public class Task35Test {
    private static final MyPersonDatabaseReadWriteLock PERSON_DATABASE = new MyPersonDatabaseReadWriteLock();
    ...
    void incorrectDataFindByAddressTest() {
